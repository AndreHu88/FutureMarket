//
//  CurrentDayCombinedChartView.swift
//  shinnyfutures
//
...
class CurrentDayCombinedChartView: CombinedChartView {
    ...
    override func initialize() {
        ...
        _xAxis = MyXAxis()
        xAxisRenderer = CurrentDayXAxisRenderer(viewPortHandler: viewPortHandler, xAxis: _xAxis as? MyXAxis, transformer: getTransformer(forAxis: .left))

        leftAxis = MyYAxis(position: .left)
        leftYAxisRenderer = CurrentDayYAxisrenderer(viewPortHandler: viewPortHandler, yAxis: leftAxis as? MyYAxis, transformer: getTransformer(forAxis: .left))
